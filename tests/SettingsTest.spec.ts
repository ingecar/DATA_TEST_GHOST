...
test.describe('Tests Settings', () => {
    ...
    test('Staff - Cambiar nombre (limite - 1)', async ({ page }) => {
    ...
    test('Staff - Cambiar nombre (limite)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Cambiar nombre', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Cambiar email (solo caracteres especiales)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Cambiar email (con "@" y ".")', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Cambiar Website (sin ".")', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Cambiar Website (valida)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Agregar Bio (limite - 1)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Agregar Bio (limite)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
    ...
    test('Staff - Agregar Bio (valida)', async ({ page }) => {
        await page.locator('a[href="#/settings/"]').click()
        await page.locator('span', {hasText: 'Staff'}).click()
        await page.locator('h3[class="apps-card-app-title"]').nth(0).click()
